...
public class DuplicateFinderPanel extends JPanel implements ActionListener {
	...
	DuplicateFinderPanel() {
		...
		hashType = true;																			// DEFAULT MEMORY SAVE
	...
	private void findDuplicates(int returnOption) {
		...
		hashType = cSave.isSelected();																// TYPE OF HASH CALCULATION
	
		if (returnOption == JFileChooser.APPROVE_OPTION) {
			File directory = chooser.getSelectedFile();
			Map<String, List<String>> duplicateList = new HashMap<String, List<String>>();
			try {
				GetDuplicateFiles.find(duplicateList, directory, hashType);									// FIND DUPLICATE FILES
